...
from signed_epm.mitigation.core import write_augmented_graph
...
def main() -> None:
    ...
    parser.add_argument("--selection-kind", choices=["batch", "sequential"], default="batch",
                        help=("batch reads recomputed batch-greedy outputs; sequential reads "
                              "FastGreedy-style rank-one-update outputs"))
    parser.add_argument("--methods", nargs="+", choices=["global"], default=["global"])
    ...
    for seed in args.seeds:
        ...
        for method in args.methods:
            if args.selection_kind == "batch":
                selection_file = (seed_root / "batch" /
                                  f"selected_{method}_batch{args.batch_size}.csv")
            else:
                selection_file = seed_root / "selected_global_global.csv"
            ...
            for rate in args.rates:
                ...
                physical, encoded = write_augmented_graph(
                    ...
                    directed, undirected, output, directed_backbone=False,
                )
